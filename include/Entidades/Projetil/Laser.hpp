...
namespace Entidades{
    ...
    private:
        ...
        bool onFloor;
    public:
        Laser(const sf::Vector2f pos, const Entidades::ID id, Entidades::Personagens::Viajante* pInim = nullptr);
        Laser(nlohmann::json atributos, const int pos, const Entidades::ID id, Entidades::Personagens::Viajante* pInim = nullptr);
        ~Laser();
