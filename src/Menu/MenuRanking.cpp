...
namespace Menu {
    MenuRanking::MenuRanking():
        Menu(3, 1, sf::Vector2f(POS_TEXTO_RANKING_X - TAM_TEXTO_RANKING_X*2, POS_TEXTO_RANKING_Y - TAM_TEXTO_RANKING_Y), sf::Vector2f(TAM_TEXTO_RANKING_X, TAM_TEXTO_RANKING_Y), "RANKING", 150),
        vectorTexto(){
        inicializaBotao();
    ...
    void MenuRanking::criarTexto(std::string linha){
        ...
        Botoes::Texto* texto = new Botoes::Texto(sf::Vector2f(640.f, 360.f), sf::Vector2f(30.f, 30.f), novaLinha, 50);
