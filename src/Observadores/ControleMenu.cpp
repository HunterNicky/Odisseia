...
Estados::MaquinaDeEstado *ControleMenu::pMaquinaDeEstado =
...
ControleMenu::ControleMenu()
    : Observer(), pMenu(nullptr), cima("Up"), baixo("Down"), enter("Enter"),
      fechar("Escape") {}
...
void ControleMenu::setMenu(Menu::Menu *pMenu) { this->pMenu = pMenu; }
