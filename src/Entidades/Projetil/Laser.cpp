...
Laser::Laser(const sf::Vector2f pos, const Entidades::ID id,
             Entidades::Personagens::Viajante *pInim)
...
Laser::Laser(nlohmann::json atributos, const int pos, const Entidades::ID id,
    ...
    : Entidade(sf::Vector2f(atributos[pos]["Posicao"][0],
               ...
               sf::Vector2f(TAM_PROJETIL, TAM_PROJETIL), id),
      pInim(pInim) {
...
void Laser::draw() { pGrafico->draw(body); }
